...
#define BOARD_Led1_FGPIO FGPIOE              /*!<@brief FGPIO peripheral base pointer */
#define BOARD_Led1_GPIO GPIOE                /*!<@brief GPIO peripheral base pointer */
#define BOARD_Led1_GPIO_PIN_MASK (1U << 31U) /*!<@brief GPIO pin mask */

/* Symbols to be used with PORT driver */
#define BOARD_Led1_PORT PORTE                /*!<@brief PORT peripheral base pointer */
#define BOARD_Led1_PIN 31U                   /*!<@brief PORT pin number */
#define BOARD_Led1_PIN_MASK (1U << 31U)      /*!<@brief PORT pin mask */
                                             /* @} */
...
/* Symbols to be used with GPIO driver */
#define BOARD_LE_FGPIO FGPIOD             /*!<@brief FGPIO peripheral base pointer */
#define BOARD_LE_GPIO GPIOD               /*!<@brief GPIO peripheral base pointer */
#define BOARD_LE_GPIO_PIN_MASK (1U << 5U) /*!<@brief GPIO pin mask */

/* Symbols to be used with PORT driver */
#define BOARD_LE_PORT PORTD               /*!<@brief PORT peripheral base pointer */
#define BOARD_LE_PIN 5U                   /*!<@brief PORT pin number */
#define BOARD_LE_PIN_MASK (1U << 5U)      /*!<@brief PORT pin mask */
                                          /* @} */
